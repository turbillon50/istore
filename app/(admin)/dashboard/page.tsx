  ...
  return (
    <div className="bg-[#1a1a1a] border border-[#262626] rounded-xl p-3 shadow-2xl">
      ...
      <div className="space-y-1">
        <p className="text-[#3b82f6] text-sm font-bold">
    ...
    <div className="space-y-6 max-w-[1600px]">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/pedidos/nuevo"
            className="flex items-center gap-2 px-3 py-2 bg-[#3b82f6] rounded-lg text-xs text-white font-semibold hover:bg-[#ea6c0a] transition-colors"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <AreaChart data={chartData} margin={{ top: 6, right: 4, bottom: 0, left: 0 }}>
              ...
              {chartMode === "7d" && (
                <ReferenceLine
                  ...
                  strokeDasharray="3 3"
                  strokeOpacity={0.3}
                  label={{ value: "Meta", fill: "#3b82f6", fontSize: 10 }}
                />
              )}
              <Area
                type="monotone"
        ...
        >
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#1a1a1a]">
            ...
            <span className="text-[10px] font-bold text-[#3b82f6] bg-[#3b82f6]/10 px-2 py-0.5 rounded-full">
            ...
            {topProducts.map((p, i) => (
              ...
              >
                ...
                <div className="text-right flex-shrink-0">
                  <p className="text-xs font-bold text-[#3b82f6]">{p.revenue}</p>
